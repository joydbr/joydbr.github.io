...
let fdb = [
    ...
    {id:60, avatar:'assets/images/fighters/igniz.jpg', ap:14, name:'Igniz', type:['gank', gankP], soul:['other', otherP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', leaders:'true', captain:'true'},
    {id:61, avatar:'assets/images/fighters/jhun.jpg', ap:14, name:'Jhun Hoon', type:['dps', dpsP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:62, avatar:'assets/images/fighters/k.jpg', ap:14, name:"K'", type:['dps', dpsP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', prota:'true', flame:'true'},
    {id:63, avatar:'assets/images/fighters/krizalid.jpg', ap:14, name:'Krizalid', type:['dps', dpsP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', flame:'true', leaders:'true', aid:'true'},
    {id:64, avatar:'assets/images/fighters/kula.jpg', ap:14, name:'Kula', type:['gank', gankP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', aid:'true'},
    {id:65, avatar:'assets/images/fighters/kyonests.jpg', ap:14, name:'Kyo NESTS', type:['dps', dpsP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', prota:'true', flame:'true'},
    {id:66, avatar:'assets/images/fighters/lin.jpg', ap:14, name:'Lin', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:67, avatar:'assets/images/fighters/maki.jpg', ap:14, name:'Maki Kagura', type:['gank', gankP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal'},
    {id:68, avatar:'assets/images/fighters/maylee.jpg', ap:14, name:'May Lee', type:['gank', gankP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal'},
    {id:69, avatar:'assets/images/fighters/newmrkarate.jpg', ap:14, name:'New Mr. Karate', type:['tank', tankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', ryu:'true'},
    {id:70, avatar:'assets/images/fighters/nameless.jpg', ap:14, name:'Nameless', type:['dps', dpsP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', flame:'true', captain:'true'},
    {id:71, avatar:'assets/images/fighters/orochi.jpg', ap:14, name:'Orochi', type:['gank', gankP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', leaders:'true', aid:'true', orochi:'true'},
    {id:72, avatar:'assets/images/fighters/oleona.jpg', ap:14, name:'Orochi Leona', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', heal:'true', ikari:'true', aid:'true', orochi:'true', iSkill:'true'},
