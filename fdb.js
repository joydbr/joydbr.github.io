...
let fdb = [
    ...
    {id:13, avatar:'assets/images/fighters/ryo.jpg', ap:12, name:'Ryo', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:[gategen, gategen, gategen], gender:'male', aid:'true', ryu:'true'},
    ...
    {id:16, avatar:'assets/images/fighters/kensou.jpg', ap:12, name:'Kensou', type:['gank', gankP], soul:['tortoise', tortoiseP], fpart:[gategen, gategen, gategen], gender:'male', aid:'true', heal:'true'},
    ...
    {id:38, avatar:'assets/images/fighters/leona.jpg', ap:13, name:'Leona', type:['gank', gankP], soul:['viper', viperP], fpart:[gategen, gategen, gategen], gender:'femal', aid:'true', orochi:'true', heal:'true', ikari:'true'},
    ...
    {id:44, avatar:'assets/images/fighters/ochris.jpg', ap:13, name:'Orochi Chris', type:['dps', dpsP], soul:['bear', bearP], fpart:[gategen, gategen, gategen], gender:'male', aid:'true', orochi:'true', flame:'true'},
    ...
    {id:81, avatar:'assets/images/fighters/ash.jpg', ap:15, name:'Ash', type:['dps', dpsP], soul:['viper', viperP], fpart:[gategen, gategen, gategen], gender:'male', aid:'true', prota:'true', flame:'true', iSkill:'true'},
    {id:82, avatar:'assets/images/fighters/mukai.jpg', ap:15, name:'Mukai', type:['gank', gankP], soul:['tiger', tigerP], fpart:[gategen, gategen, gategen], gender:'male', leaders:'true'},
    {id:83, avatar:'assets/images/fighters/magaki.jpg', ap:15, name:'Magaki', type:['tank', tankP], soul:['bear', bearP], fpart:[gategen, gategen, gategen], gender:'male', leaders:'true', heal:'true', iSkill:'true'},
    {id:84, avatar:'assets/images/fighters/iiori.jpg', ap:15, name:'Instinct Iori', type:['dps', dpsP], soul:['other', otherP], fpart:[gategen, gategen, gategen], gender:'male', prota:'true', orochi:'true', captain:'true'},
    {id:85, avatar:'assets/images/fighters/ngeese.jpg', ap:15, name:'Nightmare Geese', type:['gank', gankP], soul:['bear', bearP], fpart:[gategen, gategen, gategen], gender:'male'},
    {id:86, avatar:'assets/images/fighters/goeniko.jpg', ap:15, name:'Goeniko', type:['dps', dpsP], soul:['viper', viperP], fpart:[gategen, gategen, gategen], gender:'femal', orochi:'true'},
    {id:87, avatar:'assets/images/fighters/mrkarate.jpg', ap:15, name:'Mr. Karate', type:['gank', gankP], soul:['tortoise', tortoiseP], fpart:[gategen, gategen, gategen], gender:'male', ryu:'true'},
    ...
    {id:90, avatar:'assets/images/fighters/saiki.jpg', ap:15, name:'Saiki', type:['tank', tankP], soul:['viper', viperP], fpart:[gategen, gategen, gategen], gender:'male', leaders:'true', flame:'true'},
