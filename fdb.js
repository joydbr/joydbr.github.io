...
let promdb = [
    ...
    {id:13, lv:'Orange', rcolor:'bgorange', iname:'Obsidian', ap15:[480, 160, 1010, '?'], ap14:[405, 135, 840, 00000], ap13:[288, 96, 600, 200000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
...
let updb = [
    ...
    {lv:60, xp:[448000, 100, 252000, 196000]},
    {lv:61, xp:[512000, 100, 288000, 224000]},
    {lv:62, xp:[640000, 100, 360000, 280000]},
    {lv:63, xp:['?', '?', 396000, 308000]},
...
let fskilldb = [
    ...
    {lv:6, xp15:['?', '?', '?', '?'], xp14:[3500, 2100, 1400, '?'], xp13:['?', '?', '?', 1750], xp12:[1400, 1050, 700, 1750]},
    {lv:7, xp15:['?', '?', '?', '?'], xp14:[3750, 2250, 1500, '?'], xp13:['?', '?', '?', 1875], xp12:[1500, 1125, 750, 1875]},
    {lv:8, xp15:['?', '?', '?', '?'], xp14:[4000, 2400, 1600, '?'], xp13:['?', '?', '?', 2000], xp12:[1600, 1200, 800, 2000]},
    {lv:9, xp15:['?', '?', '?', '?'], xp14:[4250, 2550, 1700, '?'], xp13:['?', '?', '?', 2125], xp12:[1700, 1275, 850, 2125]},
    {lv:10, xp15:['?', '?', '?', '?'], xp14:[4500, 2700, 1800, '?'], xp13:['?', '?', '?', 2250], xp12:[1800, 1350, 900, 2250]},
    {lv:11, xp15:['?', '?', '?', '?'], xp14:[4750, 2850, 1900, '?'], xp13:[2375, '?', '?', 2375], xp12:[1900, 1425, 950, 2375]},
    {lv:12, xp15:['?', '?', '?', '?'], xp14:[5000, 3000, 2000, '?'], xp13:[2500, '?', '?', 2500], xp12:[2000, 1500, 1000, 2500]},
    {lv:13, xp15:['?', '?', '?', '?'], xp14:[5250, 3150, 2100, '?'], xp13:[2625, '?', '?', 2625], xp12:[2100, 1575, 1050, 2625]},
    {lv:14, xp15:['?', '?', '?', '?'], xp14:[5500, 3300, 2200, '?'], xp13:[2750, '?', '?', 2750], xp12:[2200, 1650, 1100, 2750]},
