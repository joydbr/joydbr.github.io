...
let fdb = [
    {id:1, avatar:'assets/images/kim.jpg', ap:11, name:'Kim', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true'},
    {id:2, avatar:'assets/images/yuri.jpg', ap:11, name:'Yuri', type:['dps', dpsP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', aid:'true', ryu:'true'},
    {id:3, avatar:'assets/images/andy.jpg', ap:12, name:'Andy', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:4, avatar:'assets/images/athena.jpg', ap:12, name:'Athena', type:['gank', gankP], soul:['tiger', tigerP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', aid:'true', heal:'true'},
    {id:5, avatar:'assets/images/benimaru.jpg', ap:12, name:'Benimaru', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true'},
    {id:6, avatar:'assets/images/brian.jpg', ap:12, name:'Brian', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:7, avatar:'assets/images/daimon.jpg', ap:12, name:'Daimon', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:8, avatar:'assets/images/joe.jpg', ap:12, name:'Joe', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:9, avatar:'assets/images/king.jpg', ap:12, name:'King', type:['dps', dpsP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', aid:'true'},
    {id:10, avatar:'assets/images/lucky.jpg', ap:12, name:'Lucky', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:11, avatar:'assets/images/mature.jpg', ap:12, name:'Mature', type:['dps', dpsP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', orochi:'true'},
    {id:12, avatar:'assets/images/ralf.jpg', ap:12, name:'Ralf', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male',aid:'true', ikari:'true'},
    {id:13, avatar:'assets/images/ryo.jpg', ap:12, name:'Ryo', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true'},
    {id:14, avatar:'assets/images/shermie.jpg', ap:12, name:'Shermie', type:['gank', gankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', orochi:'true'},
    {id:15, avatar:'assets/images/shingo.jpg', ap:12, name:'Shingo', type:['tank', tankP], soul:['viper', viperP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male'},
    {id:16, avatar:'assets/images/kensou.jpg', ap:12, name:'Kensou', type:['gank', gankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', aid:'true', heal:'true'},
    {id:17, avatar:'assets/images/takuma.jpg', ap:12, name:'Takuma', type:['tank', tankP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', ryu:'true'},
    {id:18, avatar:'assets/images/vice.jpg', ap:12, name:'Vice', type:['dps', dpsP], soul:['bear', bearP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal', orochi:'true'},
    {id:19, avatar:'assets/images/yashiro.jpg', ap:12, name:'Yashiro', type:['tank', tankP], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'male', orochi:'true'},
];
...
let promdb = [
    ...
    {id:7, lv:'Blue +3', rcolor:'bgblue', iname:'Vajra', ap15:['?', '?', '?', '?'], ap14:[42, 14, 84, '?'], ap13:[30, 10, 60, 80000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
    {id:8, lv:'Purple', rcolor:'bgpurple', iname:'Amethyst', ap15:['?', '?', '?', '?'], ap14:['?', '?', '?', '?'], ap13:[45, 15, 90, 100000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
    {id:9, lv:'Purple +1', rcolor:'bgpurple', iname:'Amethyst', ap15:['?', '?', '?', '?'], ap14:['?', '?', '?', '?'], ap13:[60, 20, 120, 120000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
    {id:10, lv:'Purple +2', rcolor:'bgpurple', iname:'Frostpulse', ap15:[162, 54, 335, 140000], ap14:['?', '?', '?', '?'], ap13:[96, 32, 200, 140000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
    ...
    {id:12, lv:'Purple +4', rcolor:'bgpurple', iname:'Obsidian', ap15:[330, 110, 670, '?'], ap14:[270, 90, 560, 0000], ap13:[192, 64, 400, 180000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
    {id:13, lv:'Orange', rcolor:'bgorange', iname:'Obsidian', ap15:['?', '?', '?', '?'], ap14:[405, 135, 840, 00000], ap13:[288, 96, 600, 000000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
...
let updb = [
    ...
    {lv:34, xp:['?', '?', 15300, 11900]},
    {lv:35, xp:['?', '?', 16380, 12740]},
    {lv:36, xp:['?', '?', 17460, 13580]},
    {lv:37, xp:['?', '?', 21600, 16800]},
    {lv:38, xp:['?', '?', 21600, 16800]},
    {lv:39, xp:['?', '?', 23400, 18200]},
    {lv:40, xp:['?', '?', 25200, 19600]},
    {lv:41, xp:[100, 100, 28800, 22400]},
    {lv:42, xp:[100, 100, 37800, 29399]},
    {lv:43, xp:[100, 100, 43200, 33600]},
    {lv:44, xp:[100, 100, 48600, 37800]},
    {lv:45, xp:['?', '?', 54000, '?']},
    {lv:46, xp:['?', '?', 59400, '?']},
    {lv:47, xp:[100, 100, 66600, 51800]},
    {lv:48, xp:[100, 100, 73800, 100]},
    {lv:49, xp:[100, 100, 81000, 100]},
    {lv:50, xp:['?', '?', '?', '?']},
    {lv:51, xp:[100, 100, 100, 75600]},
    {lv:52, xp:[100, 100, 100, 92400]},
...
let equipedb = [
    {lv:1, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:2, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:3, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:4, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:5, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:6, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:7, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:8, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:9, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:10, xp15:[5000, 0, 2500, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:'Green', xp15:[5000, 0, 5000, 0], sap15:[1, 'Junior eqpt scroll'], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:11, xp15:[5500, 0, 2750, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:12, xp15:[6000, 0, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:13, xp15:[0, 0, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:14, xp15:[0, 0, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:15, xp15:[0, 0, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    ...
    {lv:91, xp15:[5760000, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:92, xp15:['?', '?', '?', '?'], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:93, xp15:[6080000, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:94, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:95, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
...
let fskilldb = [
    ...
    {lv:3, xp15:['?', '?', '?', '?'], xp14:[2750, 1500, 1000, 100], xp13:[1375, 825, 550, 1375], xp12:['?', '?', '?', 1375]},
    {lv:4, xp15:['?', '?', '?', '?'], xp14:[3000, 1500, 1000, 100], xp13:[1500, 900, 600, 1500], xp12:['?', '?', '?', 1500]},
    {lv:5, xp15:[100, 100, 100, 100], xp14:[3250, 1500, 1000, 100], xp13:[1625, 975, 650, 1625], xp12:['?', '?', '?', 1625]},
    {lv:6, xp15:[100, 100, 100, 100], xp14:[3500, '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 1750]},
    {lv:7, xp15:[100, 100, 100, 100], xp14:[3750, '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 1875]},
    {lv:8, xp15:[100, 100, 100, 100], xp14:[4000, '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 2000]},
    {lv:9, xp15:[100, 100, 100, 100], xp14:[4250, '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 2125]},
    {lv:10, xp15:[100, 100, 100, 100], xp14:[4500, '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 2250]},
    {lv:11, xp15:[100, 100, 100, 100], xp14:[4750, '?', '?', '?'], xp13:[2375, '?', '?', '?'], xp12:['?', '?', '?', 2375]},
    {lv:12, xp15:[100, 100, 100, 100], xp14:[5000, '?', '?', '?'], xp13:[2500, '?', '?', '?'], xp12:['?', '?', '?', 2500]},
    {lv:13, xp15:[100, 100, 100, 100], xp14:[5250, '?', '?', '?'], xp13:[2625, '?', '?', '?'], xp12:['?', '?', '?', 2625]},
    {lv:14, xp15:[100, 100, 100, 100], xp14:[5500, '?', '?', '?'], xp13:[2750, '?', '?', '?'], xp12:['?', '?', '?', 2750]},
    {lv:15, xp15:[100, 100, 100, 100], xp14:[5750, '?', '?', '?'], xp13:[2850, '?', '?', '?'], xp12:['?', '?', '?', 2875]},
    {lv:16, xp15:[100, 100, 100, 100], xp14:[6000, '?', '?', '?'], xp13:[3000, '?', '?', '?'], xp12:['?', '?', '?', 3000]},
    {lv:17, xp15:[100, 100, 100, 100], xp14:[6250, '?', '?', '?'], xp13:[3125, '?', '?', '?'], xp12:['?', '?', '?', 3125]},
    {lv:18, xp15:[100, 100, 100, 100], xp14:[6500, '?', '?', '?'], xp13:[3250, '?', '?', '?'], xp12:['?', '?', '?', 3250]},
    {lv:19, xp15:[100, 100, 100, 100], xp14:[6750, '?', '?', '?'], xp13:[3375, '?', '?', '?'], xp12:['?', '?', '?', 3375]},
    {lv:20, xp15:[100, 100, 100, 100], xp14:[7000, '?', '?', '?'], xp13:[3500, '?', '?', '?'], xp12:['?', '?', '?', 3500]},
    {lv:21, xp15:[100, 100, 100, 100], xp14:[7250, '?', '?', '?'], xp13:[3625, '?', '?', '?'], xp12:['?', '?', '?', 3625]},
    {lv:22, xp15:[100, 100, 100, 100], xp14:[7500, '?', '?', '?'], xp13:[3750, '?', '?', '?'], xp12:['?', '?', '?', 3750]},
    {lv:23, xp15:[100, 100, 100, 100], xp14:[7750, '?', '?', '?'], xp13:[3875, '?', '?', '?'], xp12:['?', '?', '?', 3875]},
    {lv:24, xp15:[100, 100, 0, 100], xp14:[8000, '?', '?', '?'], xp13:[4000, '?', '?', '?'], xp12:['?', '?', '?', 4000]},
    {lv:25, xp15:[100, 100, 100, 100], xp14:[8250, '?', '?', '?'], xp13:[4125, '?', '?', '?'], xp12:['?', '?', '?', 4125]},
    {lv:26, xp15:[100, 100, 100, 0], xp14:[8500, '?', '?', '?'], xp13:[4250, '?', '?', '?'], xp12:['?', '?', '?', 4250]},
    {lv:27, xp15:[100, 100, 0, 100], xp14:[8750, '?', '?', '?'], xp13:[4375, '?', '?', '?'], xp12:['?', '?', '?', 4375]},
    {lv:28, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[4500, '?', '?', '?'], xp12:['?', '?', '?', 4500]},
    {lv:29, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[4625, '?', '?', '?'], xp12:['?', '?', '?', 4625]},
    {lv:30, xp15:[100, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:[4750, '?', '?', '?'], xp12:['?', '?', '?', 4750]},
    {lv:31, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[4875, '?', '?', '?'], xp12:['?', '?', '?', 4875]},
    {lv:32, xp15:[100, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:[5000, '?', '?', '?'], xp12:['?', '?', '?', 5000]},
    {lv:33, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:[12500, '?', '?', '?'], xp12:['?', '?', '?', 12500]},
    {lv:34, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[13000, '?', '?', '?'], xp12:['?', '?', '?', 13000]},
    {lv:35, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:[13500, '?', '?', '?'], xp12:['?', '?', '?', 13500]},
    {lv:36, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:[1400, '?', '?', '?'], xp12:['?', '?', '?', 14000]},
    {lv:37, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[14500, '?', '?', '?'], xp12:['?', '?', '?', 14500]},
    {lv:38, xp15:[100, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', 15000]},
    ...
    {lv:51, xp15:[100, 36000, 100, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:52, xp15:[100, 39000, 100, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:53, xp15:[70000, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:54, xp15:[75000, 45000, 30000, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:55, xp15:[80000, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:56, xp15:[90000, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 45000], xp12:['?', '?', '?', '?']},
    {lv:57, xp15:[95000, 100, 100, 0], xp14:['?', '?', '?', '?'], xp13:[47500, 28500, '?', 47500], xp12:['?', '?', '?', '?']},
    {lv:58, xp15:[100000, 100, 100, 0], xp14:['?', '?', '?', '?'], xp13:[50000, '?', '?', 50000], xp12:['?', '?', '?', '?']},
    {lv:59, xp15:[110000, 100, 100, 0], xp14:['?', '?', '?', '?'], xp13:[55000, '?', '?', 55000], xp12:['?', '?', '?', '?']},
    {lv:60, xp15:[120000, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:[60000, '?', '?', 60000], xp12:['?', '?', '?', '?']},
    {lv:61, xp15:[100, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 65000], xp12:['?', '?', '?', '?']},
    {lv:62, xp15:[100, 100, 0, 0], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 70000], xp12:['?', '?', '?', '?']},
    {lv:63, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 75000], xp12:['?', '?', '?', '?']},
    {lv:64, xp15:[100, 0, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 80000], xp12:['?', '?', '?', '?']},
    ...
    {lv:77, xp15:[100, 0, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:78, xp15:[100, 0, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:79, xp15:[0, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:80, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    ...
    {lv:84, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:85, xp15:[0, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:86, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:87, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:88, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:89, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:90, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:91, xp15:[0, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:92, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:93, xp15:[0, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:94, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:95, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:96, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:97, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
...
let eegdbap15 = [
    {gate:'Heaven', req:[hgrq1, hgrq2, hgrq3], rssreq:[25, 6, 6900000]},
    {gate:'Lake', req:[lgrq1, lgrq2, lgrq3], rssreq:[38, 11, 9000000]},
    {gate:'Fire', req:[fgrq1, fgrq2, fgrq3], rssreq:[50, 14, 11400000]},
    {gate:'Thunder', req:[tgrq1, tgrq2, tgrq3], rssreq:[62, 16, 13600000, 1]},
    {gate:'Wind', req:[wgrq1, wgrq2, wgrq3], rssreq:[75, 20, 18000000, 0, 1]},
    {gate:'Water', req:[wagrq1, wagrq2, wagrq3], rssreq:[88, 30, 27000000, 1, 1, 24, 1]},
    {gate:'Mountain/Rock', req:[mgrq1, mgrq2, mgrq3], rssreq:[100, 48, 36000000, 1, 1]},
...
let eegdbap13 = [
    {gate:'Heaven', req:[hg13rq1, hg13rq2, hg13rq3], rssreq:[20, 2, 3000000]},
    {gate:'Lake', req:[lg13rq1, lg13rq2, lg13rq3], rssreq:[30, 4, 4000000]},
    {gate:'Fire', req:[fg13rq1, fg13rq2, fg13rq3], rssreq:[40, 6, 5000000]},
    {gate:'Thunder', req:[tg13rq1, tg13rq2, tg13rq3], rssreq:[50, 9, 5920000, 1]},
    {gate:'Wind', req:[wg13rq1, wg13rq2, wg13rq3], rssreq:[60, 10, 8040000]},
    {gate:'Water', req:[wag13rq1, wag13rq2, wag13rq3], rssreq:[70, 15, 12000000, 1, 1, 10, 1]},
    {gate:'Mountain/Rock', req:[mg13rq1, mg13rq2, mg13rq3], rssreq:[80, 20, 16000000, 0, 1]},
    {gate:'Earth', req:[eg13rq1, eg13rq2, eg13rq3], rssreq:[100, 30, 20000000, 1, 1, 20, 2]}
];

let eegdbap12 = [
    {gate:'Heaven', req:[hg12rq1, hg12rq2, hg12rq3], rssreq:[16, 1, 2400000]},
    {gate:'Lake', req:[lg12rq1, lg12rq2, lg12rq3], rssreq:[24, 4, 3200000]},
    {gate:'Fire', req:[fg12rq1, fg12rq2, fg12rq3], rssreq:[26, 1, 4000000]},
    {gate:'Thunder', req:[tg12rq1, tg12rq2, tg12rq3], rssreq:[38, 4, 4800000, 1]},
    {gate:'Wind', req:[wg12rq1, wg12rq2, wg12rq3], rssreq:[48, 8, 6300000]},
    {gate:'Water', req:[wag12rq1, wag12rq2, wag12rq3], rssreq:[56, 4, 96000000, 0, 0, 5, 1]},
    {gate:'Mountain/Rock', req:[mg12rq1, mg12rq2, mg12rq3], rssreq:[64, 48, 12800000, 0, 1]},
    {gate:'Earth', req:[eg12rq1, eg12rq2, eg12rq3], rssreq:[80, 10, 16000000, 1, 1, 10]}
];