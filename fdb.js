...
let fdb = [
    ...
    {id:34, avatar:'assets/images/fighters/hinako.jpg', ap:13, name:'Hinako', type:['gank', gank], soul:['tortoise', tortoiseP], fpart:['assets/images/fpart1.png', 'assets/images/fpart2.png', 'assets/images/fpart3.png'], gender:'femal'},
...
let promdb = [
    ...
    {id:10, lv:'Purple +2', rcolor:'bgpurple', iname:'Frostpulse', ap15:[162, 54, 335, 140000], ap14:[135, 45, 280, '?'], ap13:[96, 32, 200, 140000], imgi:['assets/images/upgrades/sh1.jpg','assets/images/upgrades/st1.jpg','assets/images/upgrades/sw1.jpg']},
...
let updb = [
    ...
    {lv:51, xp:[100, 100, 97200, 75600]},
    {lv:52, xp:[100, 100, 118800, 92400]},
    {lv:53, xp:[100, 100, 129600, 100800]},
    {lv:54, xp:['?', '?', '?', '?']},
    {lv:55, xp:[275200, 100, 100, 100]},
    {lv:56, xp:[307200, 100, 172800, 100]},
    {lv:57, xp:[352000, 100, 100, 100]},
...
let fskilldb = [
    ...
    {lv:34, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[13000, '?', '?', '?'], xp12:['?', '?', '?', 13000]},
    {lv:35, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:[13500, '?', '?', '?'], xp12:['?', '?', '?', 13500]},
    {lv:36, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:[14000, '?', '?', '?'], xp12:['?', '?', '?', 14000]},
    {lv:37, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:[14500, '?', '?', '?'], xp12:['?', '?', '?', 14500]},
    ...
    {lv:64, xp15:[160000, 96000, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 80000], xp12:['?', '?', '?', '?']},
    {lv:65, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 85000], xp12:['?', '?', '?', '?']},
    {lv:66, xp15:[100, 100, 0, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', 92500], xp12:['?', '?', '?', '?']},
    {lv:67, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
    {lv:68, xp15:[100, 100, 100, 100], xp14:['?', '?', '?', '?'], xp13:['?', '?', '?', '?'], xp12:['?', '?', '?', '?']},
